...
go run ./cmd/soapbox setup -dir .. -engine-version tools/v0.2.2 -engine-sum ...
go run ./cmd/soapbox upgrade -engine-version tools/v0.2.2 -engine-mod ... -engine-sum ... -target-config ../soapbox.yaml
